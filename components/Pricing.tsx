    ...
    <section id="pricing" style={{ padding: "5rem 2rem", background: "#f8f9fb", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <p style={{ fontSize: "13px", fontWeight: 700, color: "#2563eb", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "0.75rem" }}>Pricing</p>
          <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.5rem)", fontWeight: 800, fontFamily: "Plus Jakarta Sans, sans-serif", marginBottom: "0.75rem" }}>Simple, Transparent Pricing</h2>
          <p style={{ color: "#6b7280", marginBottom: "1.5rem" }}>No hidden fees. No surprises. Cancel anytime.</p>
