...
export const defaultPages: PageSEO[] = [
  {
    id: 'home',
    url: '/',
    title: 'NexGen Digital — SEO, Ads, Web & Python Agency | Faridabad',
    ...
    canonical: 'https://nexgen-digital-psi.vercel.app/',
    robots: 'index,follow',
    ogTitle: 'NexGen Digital — Digital Marketing That Works',
  ...
  },
  {
    id: 'seo-services',
    url: '/seo-services',
    title: 'SEO Services Faridabad — Rank Higher on Google | NexGen Digital',
    ...
    canonical: 'https://nexgen-digital-psi.vercel.app/seo-services',
    robots: 'index,follow',
    ogTitle: 'SEO Services Faridabad | NexGen Digital',
  ...
  },
  {
    id: 'google-ads',
    url: '/google-ads',
    title: 'Google Ads PPC Agency Faridabad — Real Leads & Sales | NexGen',
    ...
    canonical: 'https://nexgen-digital-psi.vercel.app/google-ads',
    robots: 'index,follow',
    ogTitle: 'Google Ads Agency Faridabad | NexGen Digital',
  ...
  },
  {
    ...
    title: 'Social Media Marketing Faridabad — Instagram Facebook | NexGen',
    description: 'Build your brand on Instagram, Facebook and LinkedIn with strategic content and paid campaigns by NexGen Digital.',
    keyword: 'social media marketing faridabad',
    canonical: 'https://nexgen-digital-psi.vercel.app/social-media-marketing',
    robots: 'index,follow',
    ogTitle: 'Social Media Marketing | NexGen Digital',
  ...
  },
  {
    ...
    title: 'Website Development Faridabad — Next.js WordPress | NexGen',
    ...
    canonical: 'https://nexgen-digital-psi.vercel.app/website-development',
    robots: 'index,follow',
    ogTitle: 'Website Development Faridabad | NexGen Digital',
  ...
  },
  {
    ...
    title: 'Python Development — Automation Dashboards APIs | NexGen Digital',
    ...
    canonical: 'https://nexgen-digital-psi.vercel.app/python-development',
    robots: 'index,follow',
    ogTitle: 'Python Development & Automation | NexGen Digital',
  ...
  },
  {
    id: 'blog',
    url: '/blog',
    title: 'Digital Marketing Blog — SEO Tips & Strategies | NexGen Digital',
    description: 'Latest tips, case studies and insights on SEO, Google Ads, social media and web development from NexGen Digital Faridabad.',
    keyword: 'digital marketing blog india',
    canonical: 'https://nexgen-digital-psi.vercel.app/blog',
    robots: 'index,follow',
    ogTitle: 'Digital Marketing Blog | NexGen Digital',
  ...
  },
  {
    id: 'about',
    url: '/about',
    title: 'About NexGen Digital — Founded by Lalit Sen | Faridabad Agency',
    description: 'Learn about NexGen Digital, a results-driven digital marketing agency in Faridabad founded by Lalit Sen helping businesses grow online.',
    keyword: 'about nexgen digital lalit sen faridabad',
    canonical: 'https://nexgen-digital-psi.vercel.app/about',
    robots: 'index,follow',
    ogTitle: 'About NexGen Digital | Lalit Sen',
  ...
  },
  {
    id: 'contact',
    url: '/contact',
    title: 'Contact NexGen Digital — Free Consultation | Faridabad',
    description: 'Get a free digital marketing consultation from NexGen Digital. Contact us on WhatsApp, email or phone — based in Faridabad.',
    keyword: 'contact nexgen digital faridabad',
    canonical: 'https://nexgen-digital-psi.vercel.app/contact',
    robots: 'index,follow',
    ogTitle: 'Contact NexGen Digital | Free Consultation',
...
export const defaultSettings: SiteSettings = {
  ...
  siteUrl: 'https://nexgen-digital-psi.vercel.app',
  separator: '—',
  indexSite: true,
  followLinks: true,
  gscVerification: '',
